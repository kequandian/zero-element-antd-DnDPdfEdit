...
function renderItemsOptions(items, handle, otherProps = {}) {
  return items && /*#__PURE__*/React.createElement(ItemEdit, _extends({
    items: items
  }, handle, otherProps));
}

function renderFieldsSelect(list, value, handleChange) {
  return list && /*#__PURE__*/React.createElement(Select, {
    style: {
      width: '100%'
    },
    value: value,
...
export default (({
  ...
  return /*#__PURE__*/React.createElement(Drawer, {
    ...
    className: "ZEleA-DnDFormEdit-title"
  }, "\u5B57\u6BB5\u503C(\u540E\u7AEF\u5B57\u6BB5)"), renderFieldsSelect(isTableFields(options.table, fields, tableFields), field.value, handleFieldChange), renderBaseOptions(base, handleBaseChange), Object.keys(restRules).length ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "ZEleA-DnDFormEdit-title"
    ...
    className: "ZEleA-DnDFormEdit-title"
  }, "\u914D\u7F6E"), renderBaseOptions(config, handleConfigChange)) : null, advanced ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "ZEleA-DnDFormEdit-title"
