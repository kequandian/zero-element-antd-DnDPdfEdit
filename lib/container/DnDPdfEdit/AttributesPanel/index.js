...
var _Expect = _interopRequireDefault(require("./components/Expect"));
...
var _default = function _default(_ref) {
  ...
  (0, _react.useEffect)(function (_) {
    if (headerField && table) {
      table.splice.apply(table, [0, table.length].concat((0, _toConsumableArray2["default"])(headerField)));
      onSave();
    }
  }, [headerField, table]);
  ...
  function handleTableAdd(pdf) {
    tableList.push({
      label: "\u5B57\u6BB5".concat(tableList.length + 1),
      value: "f_".concat(tableList.length + 1),
  ...
  function handleTableIndexChange(type, index) {
    (0, _tool.arrayItemMove)(tableList, type, index);
    onSave();
  }
  ...
  return _react["default"].createElement(_drawer["default"], {
    ...
    className: "ZEleA-DnDFormEdit-title"
  }, "\u5B57\u6BB5\u503C(\u540E\u7AEF\u5B57\u6BB5)"), renderFieldsSelect(fields, field.value, handleFieldChange), (0, _render.renderBaseOptions)(base, handleBaseChange), Object.keys(restRules).length ? _react["default"].createElement(_react["default"].Fragment, null, _react["default"].createElement("div", {
    className: "ZEleA-DnDFormEdit-title"
    ...
    className: "ZEleA-DnDFormEdit-title"
  }, "\u5B50\u9879"), headerField ? null : _react["default"].createElement(_react["default"].Fragment, null, _react["default"].createElement(_button["default"], {
    type: "dashed",
    icon: "plus",
    ...
    className: "ZEleA-DnDFormEdit-title"
  }, "\u914D\u7F6E"), (0, _render.renderBaseOptions)(config, handleConfigChange)) : null, expect ? _react["default"].createElement(_react["default"].Fragment, null, _react["default"].createElement("div", {
    className: "ZEleA-DnDFormEdit-title"
  }, "\u9884\u671F"), _react["default"].createElement(_Expect["default"], {
    data: expect,
    onChange: handleExpectChange
  })) : null, advanced ? _react["default"].createElement(_react["default"].Fragment, null, _react["default"].createElement("div", {
    className: "ZEleA-DnDFormEdit-title"
    ...
    API: API
  })) : null, headerField ? null : _react["default"].createElement(_react["default"].Fragment, null, _react["default"].createElement("div", {
    className: "ZEleA-DnDFormEdit-title"
  }, "\u663E\u793A\u5B57\u6BB5"), _react["default"].createElement(_button["default"], {
    type: "dashed",
    icon: "plus",
    onClick: handleTableAdd.bind(null, pdf)
  }, "\u6DFB\u52A0\u5B57\u6BB5")), _react["default"].createElement("br", null), _react["default"].createElement("br", null), renderItemsOptions(tableList, (_renderItemsOptions = {
  ...
  }), style ? _react["default"].createElement(_react["default"].Fragment, null, _react["default"].createElement("div", {
    className: "ZEleA-DnDFormEdit-title"
